...
import { useCheckout } from './CheckoutComponents/useCheckout';
import { CheckoutForm } from './CheckoutComponents/CheckoutForm';
import { CheckoutConfirmation } from './CheckoutComponents/CheckoutConfirmation';
          ...
          <div className="lg:col-span-3">
            {step === 'info' ? (
              <CheckoutForm
                ...
                onNotasChange={(val: string) => setForm(f => ({ ...f, notas: val }))}
              />
            ) : (
