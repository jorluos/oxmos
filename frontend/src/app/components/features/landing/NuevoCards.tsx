...
import { getProductCategoryLabel, getProductPrimaryImage, getMinVariantPrice } from '../../../utils/productHelpers';
import type { Product } from '../../../types';

export function NuevoCards() {
    const { navigate, products, darkMode } = useApp();

    const byCollection = products.filter((p: Product) => getProductCategoryLabel(p) === 'Nuevo');
